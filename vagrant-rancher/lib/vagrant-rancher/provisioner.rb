  ...
  module Rancher
    class Provisioner < Vagrant.plugin('2', :provisioner)
      ...
      def configure_server
        ...
        @machine.ui.detail "#{@config.project} has id #{project_id}"
        ...
        unless project_id.nil?
          ...
          if recreate
            @machine.ui.detail "Project needs recreation..."
        ...
        @machine.ui.detail "Determining cluster id for '#{@config.project}' with id #{project_id}"
        cluster_id = @rancher.get_cluster_id @config.project
        @machine.ui.detail "Cluster id for '#{@config.project}' with id '#{project_id}' is '#{cluster_id}'"
